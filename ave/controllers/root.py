...
from ave.controllers.error import ErrorController
...
class RootController(BaseController):
    """
    The root controller for the ave application.
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "ave"

    @expose('ave.templates.index')
    def index(self):
    ...
    @expose('ave.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('ave.templates.data')
    @expose('json')
    def data(self, **kw):
        """
