# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in ave.
...
base_config.model = ave.model
base_config.DBSession = ave.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "e1f7de72-0f01-4540-a36d-06de0e6eec63"
